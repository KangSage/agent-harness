...
- Governance policy fixtures cover synthetic-data markers, unsafe public markers, high-risk reviewer coverage, decision gate shape, structured accepted-risk payloads, non-human acceptor rejection, auth-migration rollback/stop boundaries, and `not_applicable` rationale markers.
