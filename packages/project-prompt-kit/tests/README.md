...
- Governance policy fixtures cover synthetic-data markers, unsafe public markers, high-risk reviewer coverage, decision gate shape, structured accepted-risk payloads, accepted-risk false-positive guards, non-human acceptor rejection, human decision flags, concrete revisit boundaries, auth-migration rollback/stop boundaries, and `not_applicable` rationale markers.
