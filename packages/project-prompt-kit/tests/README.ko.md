...
- governance policy fixture는 synthetic data marker, unsafe public marker, high-risk reviewer coverage, accepted-risk human marker, auth-migration rollback/stop boundary, `not_applicable` rationale marker를 검증합니다.
