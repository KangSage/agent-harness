...
- governance policy fixture は、synthetic data marker、unsafe public marker、high-risk reviewer coverage、accepted-risk human marker、auth-migration rollback/stop boundary、`not_applicable` rationale marker を検証します。
